...
describe('utils.helpers', () => {
    ...
    it('mergeEvents', () => {
        ...
        expect(mergeEvents({ foo: [1, 2, 2, 3] }, { foo: [0, 4, 3, 5, 2, 6] })).toEqual({
            foo: [1, 2, 3, 0, 4, 5, 6],
        });
        expect(mergeEvents({ foo: [console.debug, console.log] }, { foo: [console.warn, console.debug, console.log] })).toEqual({
